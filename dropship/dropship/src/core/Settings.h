...
var map = [ "asia-southeast1", "europe-north1", "southamerica-east1", "asia-northeast1", "me-central2", "us-east4" ].reduce((_a, x) => { _a.set(x, find(x)); return _a; }, new Map());
    ...
    private:
        ...
        const std::map<std::string, dropship::settings::unique_server> __ow2_servers {
            ...
            */
            ...
            /* gue4
                -
            */
            { "google/us-east4", { .block = GPC_US_EAST4 } },
        ...
        const std::map<std::string, dropship::settings::unique_endpoint> __ow2_endpoints {
            ...
            { "USA - East", {
                .description = "GUE4",
                .ip_ping = "8.228.65.52",
                .blocked_servers = { "google/us-east4" },
            } },
            { "USA - West", {
                .description = "LAS1",
